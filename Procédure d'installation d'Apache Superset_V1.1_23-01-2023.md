![](RackMultipart20230310-1-5buoy6_html_20b5eed8dfe700ea.png)
...
[Prérequis 4](#_Toc124235786)

[Installation 4](#_Toc124235787)

[Initialisation de la base de données 5](#_Toc124235788)

[Installation du frontend 6](#_Toc124235789)

[Prérequis 6](#_Toc124235790)

[Installation 7](#_Toc124235791)

[Lancement de Superset 7](#_Toc124235792)

[Connexion à une base de données externe 7](#_Toc124235793)
...
1. **Installer les dépendances externes**
    ...
    ```
1. **Installer Superset en mode éditable**
    ```
    pip install -e .
    ```
...
1. Se connecter à PostgreSQL
    ...
    ```
1. Créer une base de données et un utilisateur pour Superset
...
1. **Choisir le type de base de données à connecter (MYSQL par exemple)**
